...
local function hourglass(n, f, inp)
  ...
  if n > 1 then low3p, low3i = hourglass(n-1,f,low2)
  else
  ...
  local low4i = Residual(f,f)(low3i)
  local up3i = nn.SpatialUpSamplingNearest(2)(low4i)

  -- Bring two branches together
  return nn.CAddTable()({up2,up3p}), nn.CAddTable()({up2,up3i})
end
...
function M.createModel(opt, outputDim)
  ...
  local outi_ = nn.View(-1,seqLength,3,outputRes,outputRes)(img)
